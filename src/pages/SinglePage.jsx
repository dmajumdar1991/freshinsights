      ...
      <div className="w-1/2 m-auto w-fullscreen768 p-2">
        {!sliderOpen ? (
                    ...
                    <div className="grid place-items-center">
                      <div className="h-20 w-20">
                        <img
                          src={val.logo}
                          alt="logo"
                          className="rounded-full shadow-lg cursor-pointer transition-all hover:scale-105 duration-700"
                        />
                      </div>
          ...
          <div className="relative">
            <button
              onClick={closeSlider}
              className="absolute right-2 text-2xl font-bold bg-white rounded-full p-2"
            >
              <FaTimes />
            </button>
        ...
        <div className="border-t mt-8">
          <h5 className="text-gray-400 font-bold text-base my-4 cursor-pointer">
            Share
          </h5>
                      ...
                      <div className="flex gap-4">
                        <div className="h-12 w-12">
                          <img
                            src={val.logo}
                            alt="logo"
                            className="rounded-full cursor-pointer transition-all hover:scale-110 duration-700 shadow-lg"
                          />
                        </div>
                        <div>
